...
interface KeelAPI {
  queries: {
    podcast: (i: PodcastInput) => Promise<APIResult<Podcast | null>>;
    podcasts: (i?: PodcastsInput) => Promise<APIResult<{ results: Podcast[], pageInfo: PageInfo }>>;
    getSubscription: (i: GetSubscriptionInput) => Promise<APIResult<PodcastSubscription | null>>;
    mySubscriptions: (i?: MySubscriptionsInput) => Promise<APIResult<{ results: PodcastSubscription[], pageInfo: PageInfo }>>;
    getEpisode: (i: GetEpisodeInput) => Promise<APIResult<Episode | null>>;
    episodes: (i?: EpisodesInput) => Promise<APIResult<{ results: Episode[], pageInfo: PageInfo }>>;
    episodesOfPodcast: (i: EpisodesOfPodcastInput) => Promise<APIResult<{ results: Episode[], pageInfo: PageInfo }>>;
    unlistenedEpisodes: (i?: UnlistenedEpisodesInput) => Promise<APIResult<UnlistenedEpisodesResponse>>;
    getListenedEpisode: (i: GetListenedEpisodeInput) => Promise<APIResult<ListenedEpisode | null>>;
    getListenedEpisodeByEpisode: (i: GetListenedEpisodeByEpisodeInput) => Promise<APIResult<{ results: ListenedEpisode[], pageInfo: PageInfo }>>;
  },
  mutations: {
    createPodcast: (i: CreatePodcastInput) => Promise<APIResult<Podcast>>;
    deleteSubscription: (i: DeleteSubscriptionInput) => Promise<APIResult<string>>;
    createSubscription: (i: CreateSubscriptionInput) => Promise<APIResult<PodcastSubscription>>;
    createListenedEpisode: (i: CreateListenedEpisodeInput) => Promise<APIResult<ListenedEpisode>>;
    updateSecondsListened: (i: UpdateSecondsListenedInput) => Promise<APIResult<ListenedEpisode>>;
    updateListened: (i: UpdateListenedInput) => Promise<APIResult<ListenedEpisode>>;
...
export interface UnlistenedEpisodesInput {
  podcastId?: string;
}
export interface UnlistenedEpisodesResponse {
  episodes: Episode[];
}
...
export interface MySubscriptionsInput {
  first?: number;
  after?: string;
  last?: number;
  before?: string;
...
export interface CreateSubscriptionInput {
  podcast: CreateSubscriptionPodcastInput;
}
export interface CreateSubscriptionPodcastInput {
  id: string;
}
export interface GetEpisodeInput {
  id: string;
}
export interface EpisodesInput {
  first?: number;
  after?: string;
  last?: number;
  before?: string;
...
export interface EpisodesOfPodcastPodcastInput {
  id: IdQueryInput;
}
...
export interface EpisodesOfPodcastWhere {
  podcast: EpisodesOfPodcastPodcastInput;
}
export interface EpisodesOfPodcastInput {
  where: EpisodesOfPodcastWhere;
  first?: number;
  after?: string;
  last?: number;
  before?: string;
...
export interface GetListenedEpisodeInput {
  id: string;
}
export interface UpdateSecondsListenedWhere {
  id: string;
}
export interface UpdateSecondsListenedValues {
  secondsListened: number;
}
export interface UpdateSecondsListenedInput {
  where: UpdateSecondsListenedWhere;
  values: UpdateSecondsListenedValues;
}
export interface UpdateListenedWhere {
  id: string;
}
export interface UpdateListenedValues {
  listened: boolean;
}
export interface UpdateListenedInput {
  where: UpdateListenedWhere;
  values: UpdateListenedValues;
}
export interface GetListenedEpisodeByEpisodeInput {
  where: GetListenedEpisodeByEpisodeWhere;
  first?: number;
  after?: string;
  last?: number;
  before?: string;
...
export interface GetListenedEpisodeByEpisodeWhere {
  episode: GetListenedEpisodeByEpisodeEpisodeInput;
}
export interface GetListenedEpisodeByEpisodeEpisodeInput {
  id: IdQueryInput;
}
export interface CreateListenedEpisodeInput {
  episode: CreateListenedEpisodeEpisodeInput;
}
export interface CreateListenedEpisodeEpisodeInput {
  id: string;
}
export type CreatePodcastEvent = (CreatePodcastPodcastCreatedEvent);
export interface CreatePodcastPodcastCreatedEvent {
  eventName: "podcast.created";
  occurredAt: Date;
  identityId?: string;
  target: CreatePodcastPodcastCreatedEventTarget;
}
export interface CreatePodcastPodcastCreatedEventTarget {
  id: string;
  type: string;
  data: Podcast;
}
